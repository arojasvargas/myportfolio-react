                        ...
                        <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                            <span className="navbar-text">
                                ...
                                <IconContext.Provider value={{ color: "#666666", verticalAlign: "middle" }}>
                                    <li><a href="https://drive.google.com/drive/folders/1ljNJfPXCnWaUYxTIszcqRkRnfrsLbcEd?usp=sharing" target="_blank" rel="noopener noreferrer" className={Styles.a}><FaFileAlt/><span className={`${Styles.span} d-lg-none`}> Download my resume</span></a></li>
